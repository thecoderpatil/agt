...
**Clock starts Monday 2026-04-27 09:37 ET** (MR A merged after 09:37 ET today — first fire is Monday). Expected observation window:

- First digest fire: Mon 2026-04-27 09:37 ET (paper mode; identity gate held)
- Observation week end: Mon 2026-05-04 09:37 ET (assuming no market-closed day)
- ADR §5 step 4 live-flip dispatch: queue for 2026-05-04
...
## Market-open canary (09:30 ET Monday 2026-04-27)

1. Paper CSP scan runs at 09:35 ET without `csp_allocator.skip_inactive` log line.
2. **CSP digest fires at 09:37 ET (MR A) — first fire of observation week.**
3. CC scan at 09:45 ET — picker enforces OTM floor + weekly DTE (MR !197).
4. Heartbeats <60s on both services through open.
5. Watchdog cron at 18:00 ET Mon-Fri (MR B) — first fire Monday evening; confirm `agt_scheduler.log` shows `flex_sync_watchdog:` log line with a `status=fresh` dict.
